package com.appMain.entity.estate;
...
// Constructors
    ...
    public Estate(String address, String type, Double price, Double rooms){
    ...
    @Override
    public int hashCode() {
        return Objects.hash(getId(), getAddress(), getType(), getDistrict(), getPrice(), getRooms());}
